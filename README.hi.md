...
**वॉइस साउंडबोर्ड** एक टेक्स्ट-टू-स्पीच इंजन है जो उन डेवलपर्स के लिए बनाया गया है जिन्हें केवल `.mp3` फ़ाइल की आवश्यकता नहीं है।

अधिकांश टीटीएस लाइब्रेरी एक विकल्प प्रदान करती हैं: सरल एपीआई जो सब कुछ छिपाते हैं, या जटिल, निम्न-स्तरीय उपकरण जो ऑडियो इंजीनियरिंग ज्ञान की आवश्यकता होती है। वॉइस साउंडबोर्ड आपको दोनों का सर्वश्रेष्ठ प्रदान करता है।
...
*   **शून्य-लागत एब्स्ट्रैक्शन**: भावनाएं, शैलियाँ और एसएसएमएल को एक नियंत्रण ग्राफ में संकलित किया जाता है, इसलिए रनटाइम इंजन तेज़ और हल्का रहता है।
...
**कंपाइलर** इरादे (टेक्स्ट + भावना + शैली) को `ControlGraph` में बदलता है।

**इंजन** ग्राफ को ऑडियो में बदलता है। यह भावनाओं या शैलियों के बारे में कुछ नहीं जानता है।

यह अलगाव का अर्थ है:
- रनटाइम पर सुविधाएँ "मुफ़्त" हैं (पहले से ही ग्राफ में शामिल हैं)
...
**ध्यान दें**: यह वाक्य-स्तर पर स्ट्रीमिंग है, शब्द-दर-शब्द वृद्धिशील संश्लेषण नहीं। कंपाइलर ग्राफ उत्पन्न करने से पहले वाक्य सीमाओं की प्रतीक्षा करता है। वास्तविक वृद्धिशील संश्लेषण (रोलबैक के साथ अनुमानित निष्पादन) वास्तुशिल्प रूप से समर्थित है लेकिन अभी तक लागू नहीं है।
...
| बैकएंड | गुणवत्ता | Speed | सैंपल दर | इंस्टॉल करें |
| --------- | --------- | ------- | ------------- | --------- |
| कोकोरो | उत्कृष्ट | तेज़ (जीपीयू) | 24000 हर्ट्ज | `pip install voice-soundboard[kokoro]` |
| Piper | Great | तेज़ (सीपीयू) | 22050 हर्ट्ज | `pip install voice-soundboard[piper]` |
| Mock | N/A | तत्काल | 24000 हर्ट्ज | (अंतर्निहित, परीक्षण के लिए) |
...
- **केवल सीपीयू** - किसी जीपीयू की आवश्यकता नहीं
- **गति नियंत्रण** `length_scale` के माध्यम से (उल्टा: 0.8 = तेज़, 1.2 = धीमा)
- **सैंपल दर**: 22050 हर्ट्ज (बैकएंड-विशिष्ट)

कोकोरो से आवाज मैपिंग:
```python
...
**मुख्य अपरिवर्तनीय नियम**: `engine/` कभी भी `compiler/` से आयात नहीं करता है।

## आर्किटेक्चर अपरिवर्तनीय नियम
...
3. **ग्राफ स्थिरता**: `GRAPH_VERSION` (वर्तमान में 1) को कंट्रोल ग्राफ में ब्रेकिंग परिवर्तनों पर बढ़ाया जाता है। बैकएंड संगतता के लिए इसे जांच सकते हैं।
...
यदि आपने आंतरिक तत्वों का उपयोग किया है, तो माइग्रेशन मैपिंग देखें:
